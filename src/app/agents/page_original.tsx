    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="relative flex-shrink-0">
          ...
          {/* Status dot */}
          {status === 'active' && (
            <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-orange-500 rounded-full border-2 border-zinc-900">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            {status === 'active' && (
              <span className="flex-shrink-0 text-[10px] text-orange-400 font-medium">Active</span>
            )}
          </div>
          ...
          {status === 'active' && session?.task ? (
            <div className="mt-1">
              ...
              {session.branch && (
                <span className="inline-block mt-1 px-1.5 py-0.5 bg-zinc-800 text-zinc-400 text-[10px] font-mono rounded">
                  {session.branch}
                </span>
              )}
            </div>
